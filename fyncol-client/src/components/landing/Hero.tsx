...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[90vh] flex-col justify-center overflow-hidden bg-[#020408] pt-24 pb-12 md:pt-32 transform-gpu">
      
      {/* Background Effects: Reducida la opacidad en móvil para no colgar Safari */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 h-[500px] w-[80vw] bg-blue-600/20 blur-[80px] md:blur-[100px] rounded-full mix-blend-screen opacity-30 md:opacity-40 transform-gpu" />
        <div className="absolute top-[10%] left-1/2 -translate-x-1/2 h-[300px] w-[60vw] bg-cyan-500/10 blur-[60px] md:blur-[80px] rounded-full mix-blend-screen opacity-40 md:opacity-100 transform-gpu" />
      </div>

      <div className="relative mx-auto w-full max-w-6xl px-5 md:px-8 z-10">
        <div className="mx-auto max-w-4xl text-center">
          
          <div className="reveal-on-scroll mx-auto mb-8 inline-flex items-center rounded-full border border-cyan-500/20 bg-cyan-950/20 px-4 py-1.5 backdrop-blur-md">
            <span className="flex h-2 w-2 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.6)] animate-pulse mr-2 transform-gpu"></span>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#020408] to-transparent pointer-events-none transform-gpu" />
    </section>
  );
}