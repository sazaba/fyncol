...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-[#020408] border-t border-white/5 pt-12 pb-12 md:pt-16 md:pb-16 overflow-hidden">
      
      {/* Efecto de luz superior (ahora en verde neón) */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-px bg-gradient-to-r from-transparent via-green-500/40 to-transparent" />
      ...
      <div className="mx-auto w-full max-w-7xl px-5 md:px-8 relative z-10">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between lg:items-start">
          ...
          {/* Columna Izquierda: Marca y Misión - Animada */}
          ...
          {/* Columna Derecha: Enlaces Legales y Copyright - Animada con delay */}
          <div className="reveal-on-scroll delay-100 flex flex-col gap-6 lg:items-end lg:text-right">
            ...
            <nav className="flex flex-wrap gap-x-6 gap-y-2 lg:justify-end">
              <a
                href="/terminos"
                className="text-sm font-medium text-slate-400 hover:text-green-400 transition-colors py-1"
              >
